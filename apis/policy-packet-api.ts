...
export const PolicyPacketApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiPolicyPacketSearchGet: async (page: number, pageSize: number, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const PolicyPacketApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPolicyPacketSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<PolicyPacketDTOPagedResult>>> {
            const localVarAxiosArgs = await PolicyPacketApiAxiosParamCreator(configuration).apiPolicyPacketSearchGet(page, pageSize, search, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PolicyPacketApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiPolicyPacketSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<PolicyPacketDTOPagedResult>> {
            return PolicyPacketApiFp(configuration).apiPolicyPacketSearchGet(page, pageSize, search, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class PolicyPacketApi extends BaseAPI {
     ...
     * @memberof PolicyPacketApi
     */
    public async apiPolicyPacketSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<PolicyPacketDTOPagedResult>> {
        return PolicyPacketApiFp(this.configuration).apiPolicyPacketSearchGet(page, pageSize, search, options).then((request) => request(this.axios, this.basePath));
    }
}
