...
export const BrandApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiBrandSearchGet: async (page: number, pageSize: number, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const BrandApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiBrandSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<BrandDTOPagedResult>>> {
            const localVarAxiosArgs = await BrandApiAxiosParamCreator(configuration).apiBrandSearchGet(page, pageSize, search, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const BrandApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiBrandSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<BrandDTOPagedResult>> {
            return BrandApiFp(configuration).apiBrandSearchGet(page, pageSize, search, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class BrandApi extends BaseAPI {
     ...
     * @memberof BrandApi
     */
    public async apiBrandSearchGet(page: number, pageSize: number, search?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<BrandDTOPagedResult>> {
        return BrandApiFp(this.configuration).apiBrandSearchGet(page, pageSize, search, options).then((request) => request(this.axios, this.basePath));
    }
}
